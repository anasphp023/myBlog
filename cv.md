...
- **PNPT** (Practical Network Penetration Tester) — in preparation
- **Hack The Box** — active member; practical labs (Web, Linux, Active Directory)
- **TryHackMe** — hands-on web security and pentesting
- German **telc B2**
...
- **Member — [HAK-MZ](https://hak-mz.com/)** — a security research collective working across web application, AI, and infrastructure security, focused on reproducible findings and honest severity.
...
[LinkedIn](https://www.linkedin.com/in/anas-hmaidy/) · [HackerOne](https://hackerone.com/albetisi) · [Telegram](https://t.me/anas_hmaidy) · **contact@anashamidi.com**
